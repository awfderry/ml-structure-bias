...
from utils import load_GO_annot, load_EC_annot
...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_and_continue', action='store_true')
    ...
    model = DeepFRI(output_dim=output_dim, n_channels=26, gc_dims=args.gc_dims, fc_dims=args.fc_dims,
                    ...
                    load_previous=args.load_and_continue)

    if not os.path.isfile(args.model_name + ".hdf5"):
        model.save_model()
        print("model saved")
