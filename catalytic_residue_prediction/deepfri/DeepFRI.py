...
class DeepFRI(object):
    ...
    def __init__(self, output_dim, n_channels=26, gc_dims=[64, 128], fc_dims=[512], lr=0.0002, drop=0.3, l2_reg=1e-4,
                 gc_layer=None, lm_model_name=None, model_name_prefix=None, load_previous=False):
        ...
        if load_previous and os.path.isfile(self.model_name_prefix + ".h5"):
            ...
            self.model.load_weights(self.model_name_prefix + ".h5")
    ...
    def train(self, train_tfrecord_fn, valid_tfrecord_fn,
              epochs=100, batch_size=64, pad_len=1200, cmap_type='ca',
              cmap_thresh=10.0, ont='mf', class_weight=None):
